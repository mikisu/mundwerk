...
require_once('../../../../../../wp-load.php'); // this will get global variables from theme options

$parameters = array(
	'consumer_key' => pt_get_theme_option('twitter_consumer_key'),
	'consumer_secret' => pt_get_theme_option('twitter_consumer_secret'),
	'user_token' => pt_get_theme_option('twitter_user_token'),
	'user_secret' => pt_get_theme_option('twitter_user_secret')
);
...
class ezTweet {
   ...
   // Your Twitter App Consumer Key
	private $consumer_key = ''; // '0VSSntqiTUbaY1uxz1g';

	// Your Twitter App Consumer Secret
	private $consumer_secret = ''; // 'h5StyJlu5cEO0w6VsrgbiyYKFk4xyWIO6hgF2kSQ';

	// Your Twitter App Access Token
	private $user_token = ''; // '17925886-iR2pgDVCDE4JBDwgIGDIGbh2CdKuMNRoN8WlCM2o0';

	// Your Twitter App Access Token Secret
	private $user_secret = ''; // '6U7uR4Wb3rfoX64WSq7u9Hsug6bpaE33CdZS2LFAbac';
