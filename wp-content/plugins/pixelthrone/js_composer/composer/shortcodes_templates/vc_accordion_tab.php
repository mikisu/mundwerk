...
$output .= "\n\t\t\t" . '<div class="'.$css_class.'">';
    $output .= "\n\t\t\t\t" . '<h3 class="wpb_accordion_header ui-accordion-header"><a href="#'.sanitize_title($title).'" class="inline-block">
    <div class="accordion_icon"><i class="'. $font_icons .'"></i><i class="'. $font_icons .'"></i></div><span>'.$title.'</span></a></h3>';
