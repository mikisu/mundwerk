...
class WPBakeryVisualComposerSetupAdmin extends WPBakeryVisualComposerSetup {
    ...
    public function setUpPlugin() {
        ...
        - added pixelthrone/
        */
        if(is_plugin_active_for_network('pixelthrone/js_composer/js_composer.php') || is_network_only_plugin('pixelthrone/js_composer/js_composer.php')) {
    ...
    public function editScreen_js($anyway = false) {
        if(in_array(get_post_type(), $this->composer->getPostTypes()) || $anyway) {
            /**
            Pixelthrone
            - remove activate warning - comment 1 line
            */
